        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Form Team</h3>
            </div>
            <form role="form" class="form-horizontal" action="<?php echo base_url() ?>administrator/team/add_action" method="post" enctype="multipart/form-data">
              <div class="box-body">
            ...
            <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <select class="form-control" required="required" name="SltJabatan">
                      <option>-- Pilih Master Jabatan --</option>
                      <?php
               ...
               <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="txtNama" required="required" class="form-control" placeholder="Deskripsi">
                  </div>
                </div>
