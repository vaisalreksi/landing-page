      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <form role="form" class="form-horizontal" action="<?php echo base_url() ?>administrator/gallery/update_action" method="post" enctype="multipart/form-data">
              <div class="box-body">
            ...
            <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <select class="form-control" required="required" name="SltMasterGallery">
                      ...
                      ?>
                      <option value="<?php echo $value->id; ?>,<?php echo $value->description; ?>" <?php echo ($value->id == $data->master_gallery_type_id)?'selected':''?>> <?php echo $value->description; ?></option>
