      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <form role="form" class="form-horizontal" action="<?php echo base_url() ?>administrator/banner/add_action" method="post" enctype="multipart/form-data">
              <div class="box-body">
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url()?>administrator/banner" class="btn btn-default">Kembali</a>
              </div>
            </form>
          </div>
          <!-- /.box -->
