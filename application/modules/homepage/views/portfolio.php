	...
	<div class="breadcrumb">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<ol>
					  <li class="breadcrumb-item active text-italic" style="color:black;">PORTFOLIO</li>
					</ol>
				</div>
				<div class="col-md-6">
					<ol class="float-right">
					  <li class="breadcrumb-item active text-italic">HOME / PORTFOLIO</li>
					</ol>
				</div>
			</div>
		</div>
		...
		<div class="container mt-20">
			<div class="row justify-content-center d-flex">
				<div class="mt-40 col-lg-8 text-center">
					<div class="item">
						<img src="<?php echo base_url() ?>assets/image/LOGO-PARAMATA.png" width="500" height="400">
